...
router.put('/platform/packages/:id', controller.updatePackage);
...
router.post('/platform/accounts/:id/ban', controller.banAccount);
router.post('/public/marketing-signups', controller.createPublicMarketingSignup);
router.post('/public/marketing-signups/login', controller.loginPublicMarketingSignup);
router.get('/public/marketing-signups/session', controller.getPublicMarketingSession);
